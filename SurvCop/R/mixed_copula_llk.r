...
mixed_copula_llk=function(uplus, uminus, vplus, vminus, isdiscu, isdiscv, fam, param1, param2=0)
{ out= .Fortran("mixedcopulallk",
      as.double(uplus), as.double(uminus), as.double(vplus), as.double(vminus), as.integer(isdiscu), as.integer(isdiscv), as.integer(fam),
      as.double(param1),as.double(param2),
      llk=as.double(0))
  out$llk
}